package VerificadorDeIdadeSwing;

import java.time.LocalDateTime;
import java.time.format.DateTimeFormatter;

public class TelaVerificadorDeIdadeSwing extends javax.swing.JFrame {
    
    LocalDateTime data = LocalDateTime.now();
    DateTimeFormatter  formato = DateTimeFormatter.ofPattern("yyyy");
    int anoAtual = Integer.parseInt(formato.format(data));
    
    public TelaVerificadorDeIdadeSwing() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerificadorDeIdadeSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerificadorDeIdadeSwing().setVisible(true);
            }
        });
    }
